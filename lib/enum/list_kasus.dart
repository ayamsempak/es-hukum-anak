...
Kasus loadKasusDiskriminasi() {
  Kasus kasusDiskriminasi = Kasus(
    name: "Diskriminasi dan Penelantaran Anak",
    listPertanyaan: [
      "Apakah pelaku melakukan tindakan yang tidak adil terhadap anak? baik itu terhadap ras, suku bangsa, agama ataupun status sosial?",
...
Kasus loadKasusEksploitasi() {
  Kasus kasusEksploitasi = Kasus(
    name: "Eksploitasi",
    listPertanyaan: [
      "Apakah pelaku memanfaatkan fisik dan tenaga si anak agar bekerja demi keuntungan orang lain? Contoh: menyuruh anak melakukan pekerjaan yang seharusnya belum mampu dikerjakan oleh manusia seumur mereka.",
...
Kasus loadKasusPenganiayaan() {
  Kasus kasusPenganiayaan = Kasus(
    name: "Penganiayaan dan Kekerasan Seks",
    listPertanyaan: [
...
Kasus loadKasusPenculikan() {
  Kasus kasusPenculikan = Kasus(
    name: "Penculikan dan Transplantasi Organ",
    listPertanyaan: [
...
Kasus loadKasusPemilihanAgama() {
  Kasus kasusPemilihanAgama = Kasus(
    name: "Pemilihan Agama, Pemaksaan dan Narkotika",
    listPertanyaan: [
      ...
      "Apakah pelaku memperalat anak untuk kepentingan militer atau memaksa anak terlibat dalam kerusuhan social atau peristiwa yang mengandung unsur kekerasan?",
